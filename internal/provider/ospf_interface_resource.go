...
const (
	create_rs_ospfInterface = "/apps/protocols.eda.nokia.com/v2/namespaces/{namespace}/ospfinterfaces"
	read_rs_ospfInterface   = "/apps/protocols.eda.nokia.com/v2/namespaces/{namespace}/ospfinterfaces/{name}"
	update_rs_ospfInterface = "/apps/protocols.eda.nokia.com/v2/namespaces/{namespace}/ospfinterfaces/{name}"
	delete_rs_ospfInterface = "/apps/protocols.eda.nokia.com/v2/namespaces/{namespace}/ospfinterfaces/{name}"
)
