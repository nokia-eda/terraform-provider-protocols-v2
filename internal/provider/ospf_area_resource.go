...
const (
	create_rs_ospfArea = "/apps/protocols.eda.nokia.com/v2/namespaces/{namespace}/ospfareas"
	read_rs_ospfArea   = "/apps/protocols.eda.nokia.com/v2/namespaces/{namespace}/ospfareas/{name}"
	update_rs_ospfArea = "/apps/protocols.eda.nokia.com/v2/namespaces/{namespace}/ospfareas/{name}"
	delete_rs_ospfArea = "/apps/protocols.eda.nokia.com/v2/namespaces/{namespace}/ospfareas/{name}"
)
