...
const (
	create_rs_staticRoute = "/apps/protocols.eda.nokia.com/v2/namespaces/{namespace}/staticroutes"
	read_rs_staticRoute   = "/apps/protocols.eda.nokia.com/v2/namespaces/{namespace}/staticroutes/{name}"
	update_rs_staticRoute = "/apps/protocols.eda.nokia.com/v2/namespaces/{namespace}/staticroutes/{name}"
	delete_rs_staticRoute = "/apps/protocols.eda.nokia.com/v2/namespaces/{namespace}/staticroutes/{name}"
)
