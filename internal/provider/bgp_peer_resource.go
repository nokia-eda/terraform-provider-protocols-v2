...
const (
	create_rs_bgpPeer = "/apps/protocols.eda.nokia.com/v2/namespaces/{namespace}/bgppeers"
	read_rs_bgpPeer   = "/apps/protocols.eda.nokia.com/v2/namespaces/{namespace}/bgppeers/{name}"
	update_rs_bgpPeer = "/apps/protocols.eda.nokia.com/v2/namespaces/{namespace}/bgppeers/{name}"
	delete_rs_bgpPeer = "/apps/protocols.eda.nokia.com/v2/namespaces/{namespace}/bgppeers/{name}"
)
