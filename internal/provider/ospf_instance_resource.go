...
const (
	create_rs_ospfInstance = "/apps/protocols.eda.nokia.com/v2/namespaces/{namespace}/ospfinstances"
	read_rs_ospfInstance   = "/apps/protocols.eda.nokia.com/v2/namespaces/{namespace}/ospfinstances/{name}"
	update_rs_ospfInstance = "/apps/protocols.eda.nokia.com/v2/namespaces/{namespace}/ospfinstances/{name}"
	delete_rs_ospfInstance = "/apps/protocols.eda.nokia.com/v2/namespaces/{namespace}/ospfinstances/{name}"
)
