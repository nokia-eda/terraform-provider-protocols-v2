...
page_title: "protocols-v2_route_reflector_list Data Source - protocols-v2"
subcategory: ""
description: |-
  
---

# protocols-v2_route_reflector_list (Data Source)
...
- `ipv4_client_selectors` (List of String) Label selector used to select the RouteReflectorClients to which the iBGP sessions are established for IPv4.
...
- `ipv6_client_selectors` (List of String) Label selector used to select the RouteReflectorClients to which the iBGP sessions are established for IPv6.
