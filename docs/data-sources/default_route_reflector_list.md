...
page_title: "protocols-v2_default_route_reflector_list Data Source - protocols-v2"
subcategory: ""
description: |-
  
---

# protocols-v2_default_route_reflector_list (Data Source)
...
- `rtc` (Attributes) Parameters related to the RTC SAFI. (see [below for nested schema](#nestedatt--items--spec--rtc))
...
- `vpn_ipv4_unicast` (Attributes) Parameters related to the VPN IPv4 Unicast AFI/SAFI. (see [below for nested schema](#nestedatt--items--spec--vpn_ipv4_unicast))
- `vpn_ipv6_unicast` (Attributes) Parameters related to the VPN IPv6 Unicast AFI/SAFI. (see [below for nested schema](#nestedatt--items--spec--vpn_ipv6_unicast))
