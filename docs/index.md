---
page_title: "protocols-v2 Provider"
---

# protocols-v2 Provider

This provider is used to interact with the resources provided by the **protocols-v2** application of the [Nokia EDA](https://docs.eda.dev) platform.
